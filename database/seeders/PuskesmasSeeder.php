        ...
        */
        ...
        $data = [
            ...
            [
                ...
                'name' => 'Leuwigajah',
                'village' => 'Leuwigajah',
                'address' => 'Jl. Kihapit Barat RT 8 RW 9 Kel. Leuwigajah, Kec. Cimahi Selatan',
                'phone' => '(022) 6677649',
                'service_type' => '2',
            ],
            [
                ...
                'name' => 'Melong Tengah',
                'village' => 'Melong',
                'address' => 'Jl. Melong Tengah RT 2 RW 4 Kel. Melong, Kec. Cimahi Selatan',
                'phone' => '0226004991',
                'service_type' => '2',
            ],
            [
        ...
        foreach ($data as $item) {
            $village = DB::table('villages')->where('name', $item['village'])->first();
            ...
            if ($village) {
                DB::table('puskesmas')->insert([
                    ...
                    'email' => null,
                    'head_name' => null,
                    'service_type' => $item['service_type'], // 1 / 2
                    'description' => null,
                    'created_at' => now(),
                    'updated_at' => now(),
                ]);
